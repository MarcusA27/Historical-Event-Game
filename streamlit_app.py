...
with st.container():
    ...
    def check_one():
        if date_1 < date_2:
            col1.write("Correct")
            col1.write(f"The {event_1} took place in {date_1}")
            col1.write(f"The {event_2} took place in {date_2}")
    ...
    col1.button(f"{event_1}",on_click=check_one, width=700)
    col2.button(f"{event_2}\n", on_click=check_two, width=700)
